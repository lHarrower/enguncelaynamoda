...
export const SAMPLE_SAVED_OUTFITS: Outfit[] = [
  {
    ...
    items: [
      SAMPLE_WARDROBE[0], // Silk Blouse
      SAMPLE_WARDROBE[1], // Pleated Skirt
      SAMPLE_WARDROBE[3], // Pearl Earrings
      SAMPLE_WARDROBE[4]  // Black Blazer
    ],
  ...
  },
  {
    ...
    items: [
      SAMPLE_WARDROBE[2], // Summer Dress
      SAMPLE_WARDROBE[6], // Denim Jacket
      SAMPLE_WARDROBE[5], // White Sneakers
      SAMPLE_WARDROBE[7]  // Gold Necklace
    ],
