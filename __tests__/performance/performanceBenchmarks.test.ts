...
describe('Performance Benchmarks - AYNA Mirror System', () => {
  ...
  describe('Service-Specific Performance', () => {
    ...
    it('should calculate outfit compatibility quickly', async () => {
      ...
      const startTime = performance.now();
      const compatibilityScore = await intelligenceService.calculateOutfitCompatibility(mockItems as any);
      const endTime = performance.now();
      const duration = endTime - startTime;
  ...
  describe('Memory and Resource Usage', () => {
    ...
    it('should handle timeout scenarios gracefully', async () => {
      ...
      const recommendations = await aynaMirrorService.generateDailyRecommendations('timeout-test-user');
